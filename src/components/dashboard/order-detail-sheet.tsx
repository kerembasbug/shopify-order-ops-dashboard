    ...
    return (
      <div className="detail-sheet-overlay">
        <Link
          ...
          className="detail-sheet-overlay__backdrop"
          href={closeHref}
        />
        <aside className="detail-sheet detail-sheet--floating detail-sheet--empty">
  ...
  return (
    <div className="detail-sheet-overlay">
      <Link
        ...
        href={closeHref}
      />
      <aside className="detail-sheet detail-sheet--floating">
